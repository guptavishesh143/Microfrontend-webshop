  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-zinc-50 font-sans dark:bg-zinc-950">
      ...
      <main style={{ marginTop: '128px' }} className="flex flex-col items-center justify-center p-24 bg-white dark:bg-zinc-900 rounded-xl shadow-lg w-full max-w-2xl">
        ...
        {sharedData ? (
          <div className="w-full mb-8 p-6 bg-emerald-50 dark:bg-emerald-900/30 rounded-lg border border-emerald-200 dark:border-emerald-800 text-center">
            <h2 className="text-sm font-bold text-emerald-800 dark:text-emerald-300 uppercase tracking-wider mb-2">Checkout Data Value</h2>
            <p className="text-2xl font-black text-emerald-900 dark:text-emerald-100">{sharedData}</p>
          </div>
        ) : (
        ...
        <div className="flex gap-4">
          ...
          <a href="http://localhost:3004">
            <SharedButton>Next (Blogs App)</SharedButton>
          </a>
        </div>
      </main>
    </div>
